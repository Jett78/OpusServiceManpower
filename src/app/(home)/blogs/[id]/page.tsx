  ...
  return (
   <main>
     <div className='lg:w-9/12 w-11/12 mx-auto md:my-16 my-8'>
      <h1 className='font-extrabold lg:text-4xl md:text-3xl uppercase text-2xl md:text-left tracking-wide'>{blog.title}</h1>
      ...
      <p className='font-medium  md:text-lg text-[12px] md:py-6 py-2'>{blog.desc2}</p>
      <p className='font-medium  md:text-lg text-[12px] md:py-6 py-2'>{blog.desc3}</p>
      <p className='font-medium  md:text-lg text-[12px] md:py-6 py-2'>{blog.conclusion}</p>
