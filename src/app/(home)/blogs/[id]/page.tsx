  ...
  return (
    <main>
      <div className="lg:w-9/12 w-11/12 mx-auto md:my-16 my-8">
        ...
        />
        <h2 className="text-sm font-semibold">Author: <span>John Doe</span></h2>
          </div>
        ...
        <p className="font-medium  md:text-lg text-[12px] md:py-6 py-2">
          {blog.desc2}
        </p>
        <p className="font-medium  md:text-lg text-[12px] md:py-6 py-2">
          {blog.desc3}
